...
export const Information = ({ addStyles, addStyles2, addStyles3 , header, text1, text2,list1, list2, list3, list4, list5, list6,list7, text3 }) => {
    return (
        <div className={[styles.container, addStyles].join(' ')}>
            <div className={[styles.discription, addStyles3].join(' ')}>
                ...
                <ul className={styles.list}>
                    ...
                    <li className={styles.text}>{list4}</li>
