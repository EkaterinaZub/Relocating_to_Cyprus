...
export const questions = [
    ...
    },
    {
        ...
        question: 'How long does it take to buy a property in Cyprus?',
        answer: 'Answer: The whole procedure for pur-chasing property in Cyprus should only take about 1-3 months. Of course, each situation is different and this timeframe may vary from one individual to another. Our relocation services aim to simplify this process by providing guidance and assistance from start to finish.  '
    ...
    },
    {
        ...
        investments: 'Migration',
        question: 'Question: Am I eligible to receive public healthcare if I am a permanent resident of Cyprus?',
        answer: 'Answer: Yes, you are. In accordance with National Legislation, Cyprus citizens with permanent residency rights and those whose ordinary residence is in an area controlled by the Cyprus Government are entitled to healthcare services under GHS. '
    ...
    },
    {
        ...
        investments: 'Family Relocation',
        question: 'Question: Do my children have the option of attending a private or public school in Cyprus if I have a permanent residency?',
        answer: 'Answer: Yes. Public schools are free, while private educational institutions have tuition. '
    ...
    },
    {
        ...
        investments: 'Migration',
        question: 'Question: How can I contact PAM Consulting?',
        answer: 'Answer: You can contact our team by simply visiting the “Contact Us” page, where you can find out contact details (email, telephone number) or fill in a form so we can get back to you as soon as possible.'
